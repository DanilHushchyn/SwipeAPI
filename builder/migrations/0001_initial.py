    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gallery', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='photos', to='builder.gallery')),
            ],
            options={
                'db_table': 'photo',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='document', max_length=50)),
                ('file_format', models.CharField(blank=True, max_length=5, null=True)),
                ('dock_kit', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='builder.dockit')),
            ],
            options={
                'db_table': 'file',
            },
